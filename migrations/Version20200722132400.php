...
final class Version20200722132400 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE project ADD clients_id INT NOT NULL');
        $this->addSql('ALTER TABLE project ADD CONSTRAINT FK_5C93B3A4AB014612 FOREIGN KEY (clients_id) REFERENCES client (id)');
        $this->addSql('CREATE INDEX IDX_5C93B3A4AB014612 ON project (clients_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE project DROP clients_id');
    }
}
