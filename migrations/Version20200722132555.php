...
final class Version20200722132555 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE technos_projects ADD CONSTRAINT FK_B972ED7B25F7B143 FOREIGN KEY (technos_id) REFERENCES techno (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE technos_projects ADD CONSTRAINT FK_B972ED7B1EDE0F55 FOREIGN KEY (projects_id) REFERENCES project (id) ON DELETE CASCADE');
    }
